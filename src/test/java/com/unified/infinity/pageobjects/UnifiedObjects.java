...
//	@FindBy(xpath ="//img[@src='assets/img/logo-jee.png']") public WebElement InfinityLogo;			//Infinity Logo
	...
	@FindBy(xpath ="//input[@name='phone']") public WebElement PhoneNumberTxb;
...
//	Target Exams
	...
	//ILTS OBjects
	@FindBy(xpath ="//h2[text()='JEE Main Infinity Learn Test Series (ILTS)']")
	public WebElement ILTSTestopen;
    ...
    @FindBy(xpath ="//button[text()='RE-ATTEMPT NOW']") public WebElement ReAttemptbtn;
	@FindBy(xpath ="//button[text()='REGISTER NOW']") public WebElement RegisterBtn;
	@FindBy(xpath ="//button[text()='Success']") public WebElement Successmsg;
	@FindBy(xpath ="//div[text()='Subscription details']") public WebElement subscriptiondetails;
	@FindBy(xpath ="//button[text()='Get Started']") public WebElement GetStartedbtn;
	@FindBy(xpath ="//button[text()='ATTEMPT NOW']")  public WebElement ScoreAttemptnow;
	//score Subscriptions
	@FindBy(xpath ="//button[text()='NEXT']") public WebElement ScoreNxtBtn;
	...
	//MCt-Inetgertype qstn
	@FindBy(xpath ="//button[text()=' 3 ']")   public WebElement number3;
	@FindBy(xpath ="//div[text()=' Clear ']") public WebElement clearbrn;
...
//	Subscriptions
	...
	@FindBy(xpath ="//h3[contains(text(),'49999')]//parent::div[@class='pricehdng-only']//parent::div//following-sibling::button") public WebElement Add49999ToCart;
	@FindBy(xpath ="//h3[contains(text(),'39999')]//parent::div[@class='pricehdng-only']//parent::div//following-sibling::button") public WebElement Add39999ToCart;
	...
	@FindBy(xpath ="//h3[contains(text(),'12999')]//parent::div[@class='pricehdng-only']//parent::div//following-sibling::button") public WebElement Add12999ToCart;
	...
	@FindBy(xpath ="//h3[text()='NEET 2023 Full Course']") public WebElement NEET2023FullCourse;
	@FindBy(xpath ="//h3[text()='UAT LIVE Course for JODO ']") public WebElement UATLivecourse;
	@FindBy(xpath ="//div[text()=' Select']") public WebElement Batchslt;
	...
	@FindBy(xpath ="//div[@class='SUBCRP-cart-address-box']")  public WebElement clksltaddress;
 	@FindBy(xpath ="//h3[text()='Select a Payment Type']") public WebElement VerifyPymtPage;
 	@FindBy(xpath ="//button[text()='MY SUBSCRIPTIONS ']")  public WebElement Mysubscriptions;
...
//	Subscriptions page
	...
	@FindBy(xpath ="//button[text()='SEND OTP']")
	public WebElement doubtsSendOTP;
	@FindBy(xpath ="//input[@name='resetpassword']")
