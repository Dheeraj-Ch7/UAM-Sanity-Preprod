...
//	To Launch the WebApplication
	public static void launchWebApp(String APP_URL) throws Exception {
		...
		try {
			...
			LoggerUtil.printExtentLogWithScreenshot1("Fail","Could not launch the application: "+APP_URL+ " due to the exception "+e.toString());
...
//	To Enter the Values to the Input fields
	public static void SendKeys(WebElement webElement, String text) throws Exception {
		try {
			...
			LoggerUtil.printExtentLogWithScreenshot1("Fail","Unable to Enter Value to the Object  "+ webElement.toString().split("xpath: //")[1] +" due to the exception "+e.toString());
	...
	public static void Click(WebElement webElement) throws Exception {
		...
		String sException = null;
			...
			if (j > 10) {
				LoggerUtil.printExtentLogWithScreenshot1("Fail","Unable to click webelement: " + webElement.toString()+ "due to " +sException);
...
//	Wait for element to Display
	...
	public static boolean isPresent(WebElement webElement, int timeout) throws Exception {
		...
		try {
			...
			LoggerUtil.printExtentLogWithScreenshot1("Fail","Unable to find the element "+ webElement.toString().split("xpath: //")[1] +" due to the exception "+e.toString());
	...
	public static boolean selectByValue(WebElement webElement, String value) throws Exception {
    	...
    	try {
			...
			LoggerUtil.printExtentLogWithScreenshot1("Fail","Unable to select the value from listbox: "+ webElement.toString().split("xpath: //")[1] +" due to the exception "+ e.toString());
